...
export default function Reset({ email, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setDone(true); // go to success screen
    } catch (err) {
  ...
  return (
    <div className="w-1/2 flex items-center justify-center p-8">
      <div className="w-80 p-6 rounded-lg">
        ...
        <p className="text-gray-500 text-sm mb-6">Create a new password</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center border border-gray-300 rounded-md px-3 py-2.5 mb-4 focus-within:border-red-400 focus-within:ring-1 focus-within:ring-red-400">
            <svg
          ...
          <div className="flex items-center border border-gray-300 rounded-md px-3 py-2.5 mb-6 focus-within:border-red-400 focus-within:ring-1 focus-within:ring-red-400">
            <svg
              className="w-4 h-4 text-gray-400 mr-3"
              fill="none"
              stroke="currentColor"
          ...
          <div className="flex gap-3">
            <button
              ...
              className="w-full border border-gray-300 text-gray-700 py-2.5 rounded-md hover:bg-gray-50 text-sm font-medium transition-colors"
              disabled={loading}
            >
              Cancel
            </button>
