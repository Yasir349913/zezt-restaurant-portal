...
/**
 * ✅ Update an existing deal (partial fields allowed)
 * PUT /deal/:id
 * Backend expects: PUT /deal/:id with payload
 */
...
/**
 * ✅ Delete an existing deal with timeslots
 * DELETE /deal/delete/:dealId
 * Backend expects: DELETE /deal/delete/:dealId
 */
export const deleteDeal = async (id) => {
  if (!id) throw new Error("deal id is required");
  //  FIXED: Added /delete/ in the path to match backend route
